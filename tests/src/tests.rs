...
// generated unit test for contract week-06-transaction-validator
#[test]
fn test_week_06_transaction_validator() {
    // deploy contract
    let mut context = Context::default();
    let out_point = context.deploy_cell_by_name("week-06-transaction-validator");
